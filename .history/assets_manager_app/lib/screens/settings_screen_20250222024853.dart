...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      isDarkModeEnabled = prefs.getBool('dark_mode_enabled') ?? false;
  ...
  Future<void> _saveSettings() async {
    ...
    await prefs.setBool('dark_mode_enabled', isDarkModeEnabled);
    ...
    await prefs.setString('selected_language', currentLanguage);
  }
